pmonbart <- function(x.train, y.train, x.test=matrix(0.0,0,0),
                     ##sigest=NA, sigdf=3, sigquant=.90,
                     k=2.0, power=.8, base=.25, #regular bart is 2,.95
                     binaryOffset = NULL,
                     ##sigmaf=NA, lambda=NA, fmean = mean(y.train),
                     ntree=200, ndpost=1000, nskip=100, mgsize=50,
